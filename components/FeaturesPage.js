...
import { BarChart2, Shield, Zap, Activity, Code, ChartPie, Clock, Database, AlertTriangle, ArrowRight, Eye, Terminal, PieChart } from 'lucide-react';
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#FDFDFD]">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-xl border border-gray-200 hover:shadow-md transition-shadow">
              ...
              <ul className="space-y-3 text-gray-700">
                ...
                <li className="flex items-start">
                  ...
                  <span>Cost attribution by application/feature</span>
                </li>
                <li className="flex items-start">
            ...
            {/* Anomaly Detection */}
            <div className="bg-red-50 p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow">
            ...
            {/* Easy Integration */}
            <div className="bg-cyan-50 p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow">
              <div className="bg-cyan-100 p-3 rounded-full inline-block mb-4">
